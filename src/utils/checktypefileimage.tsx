...
const CHECKTYPEIMAGE = (file: UploadFile<unknown>) => {
  const fileExtension = file.name.split(".").pop() || "";

  const fileTypes = [
    {
      types: [...TYPE_FILES.ARR_FILE_PNG, "png"],
      imagePath: "PNG_file_icon.png",
      alt: "PNG",
    },
    {
      types: [...TYPE_FILES.ARR_FILE_JPG, "jpg", "jpeg"],
      imagePath: "JPG_file_icon.png",
      alt: "JPG",
    },
    {
      types: [...TYPE_FILES.ARR_FILE_TYPES_PDF, "pdf"],
      imagePath: "PDF_file_icon.png",
      alt: "PDF",
    },
    {
      types: [...TYPE_FILES.ARR_FILE_TYPES_WORD, "doc", "docx"],
      imagePath: "WORD_file_icon.png",
      alt: "WORD",
    },
    {
      types: [...TYPE_FILES.ARR_FILE_TYPES_EXCEL, "xls", "xlsx"],
      imagePath: "EXCEL_file_icon.png",
      alt: "EXCEL",
    },
    {
      types: [...TYPE_FILES.ARR_FILE_TYPES_TXT, "txt"],
      imagePath: "TXT_file_icon.png",
      alt: "TXT",
    },
    {
      types: [...TYPE_FILES.ARR_FILE_TYPES_PPT, "ppt"],
      imagePath: "PPT_file_icon.png",
      alt: "PPT",
    },
    {
      types: [...TYPE_FILES.ARR_FILE_TYPES_MP4, "mp4"],
  ...
  for (const fileType of fileTypes) {
    if (
      ...
      return (
        <Image
          src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/${fileType.imagePath}`}
          preview={false}
          width={"75%"}
          alt={fileType.alt}
        />
